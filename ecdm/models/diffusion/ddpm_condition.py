...
from ecdm.util import exists, default, count_params, instantiate_from_config
...
class DDPM(pl.LightningModule):
    ...
    @torch.no_grad()
    def sample(self, c, batch_size=16, return_intermediates=False):
    ...
    def predict_step(self, batch, batch_idx):
        ...
        with self.ema_scope():
            ...
            shape = (
                self.channels,
                self.model.diffusion_model.image_size[0],
                self.model.diffusion_model.image_size[1],
            )
            ...
            # samples, z_denoise_row = self.sample(c, batch_size=batch_size,
        ...
        if sample:
            ...
            with self.ema_scope():
                samples, denoise_row = self.sample(
                    c, batch_size=N, return_intermediates=True
                )
